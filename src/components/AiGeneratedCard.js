                ...
                <div className="card-inner">
                    ...
                    <div className="card-back">
                        <div className="flex flex-row flex-shrink-0 justify-center items-center gap-2">
                            <div className="rounded-full flex items-center justify-center bg-[rgba(248,248,248,0.01)] shadow-[0px_0px_8px_0px_rgba(248,248,248,0.25)_inset,0px_32px_24px_-16px_rgba(0,0,0,0.40)] h-4 w-4 circle-1 style-ed6AE">
                                <svg className="h-2 w-2" viewBox="0 0 512 512" clipRule="evenodd" fillRule="evenodd" imageRendering="optimizeQuality" textRendering="geometricPrecision" shapeRendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="rounded-full flex items-center justify-center bg-[rgba(248,248,248,0.01)] shadow-[0px_0px_8px_0px_rgba(248,248,248,0.25)_inset,0px_32px_24px_-16px_rgba(0,0,0,0.40)] h-6 w-6 circle-2 style-pvfli">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" className="h-3 w-3 dark:text-white" viewBox="0 0 24 24" strokeWidth={0} fill="currentColor" stroke="currentColor">
                            ...
                            <div className="h-8 w-8 rounded-full flex items-center justify-center bg-[rgba(248,248,248,0.01)] shadow-[0px_0px_8px_0px_rgba(248,248,248,0.25)_inset,0px_32px_24px_-16px_rgba(0,0,0,0.40)] circle-3 style-co8vS">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 28 28" width={28} className="h-4 w-4 dark:text-white">
                            ...
                            <div className="rounded-full flex items-center justify-center bg-[rgba(248,248,248,0.01)] shadow-[0px_0px_8px_0px_rgba(248,248,248,0.25)_inset,0px_32px_24px_-16px_rgba(0,0,0,0.40)] h-6 w-6 circle-4 style-ce5cf">
                                <svg className="h-3 w-3" viewBox="0 0 287.56 191" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" id="Layer_1">
                                    <defs>
                            ...
                            <div className="rounded-full flex items-center justify-center bg-[rgba(248,248,248,0.01)] shadow-[0px_0px_8px_0px_rgba(248,248,248,0.25)_inset,0px_32px_24px_-16px_rgba(0,0,0,0.40)] h-4 w-4 circle-5 style-cq179">
                                <svg className="h-2 w-2" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="none">
...
position: absolute;
  ...
  .card-inner {
    ...
    transition: transform 0.6s; /* Adjusted transition speed */
  }
